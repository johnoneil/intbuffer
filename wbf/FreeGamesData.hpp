...
#ifndef __WBF_FREEGAMESDATA_HPP__
#define __WBF_FREEGAMESDATA_HPP__
...
public:
  ...
  ///=====================================
  static FreeGamesData Parse(const EDC::IGameEvent& gameEvent);
  static FreeGamesData Parse(const EDC::IGameEvent& gameEvent, Int32& index);
...
///
bool IsFreeGamesData(const EDC::IGameEvent& gameEvent);
