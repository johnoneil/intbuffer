...
public:
  ...
  ///=====================================
  static FastFireBonus Parse(const std::vector< Int32 >& array);
  static FastFireBonus Parse(const std::vector< Int32 >& array, Int32& index);
...
///
bool IsFastFireBonus(const std::vector< Int32 >& array);
